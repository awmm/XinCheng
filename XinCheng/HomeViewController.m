...
{
    _searchBar=[[UISearchBar alloc]initWithFrame:CGRectMake(0.0f, 64.0f, kScreenWidth, 88.0f)];
    _searchBar.placeholder=@"小区名称/物业名称/拜访时间";
    
    _searchBar.showsScopeBar=YES;
    _searchBar.scopeButtonTitles=[NSArray arrayWithObjects:@"全部",@"当日",@"本周",@"本月",nil];
...
-(void)drawTableView
{
    _visitTableView=[[UITableView alloc]initWithFrame:CGRectMake(0.0f, 192.0f, kScreenWidth, kScreenHeight-192) style:UITableViewStylePlain];
...
-(void)drawTableView2
{
    _statisticsTableView=[[UITableView alloc]initWithFrame:CGRectMake(0.0f, 104.0f, kScreenWidth, kScreenHeight-144) style:UITableViewStylePlain];
    _statisticsTableView.delegate=self;
    _statisticsTableView.dataSource=self;
    [_statisticsView addSubview:_statisticsTableView];

    _areaVisitTableView=[[UITableView alloc]initWithFrame:CGRectMake(0.0f, 192.0f, kScreenWidth, kScreenHeight-232) style:UITableViewStylePlain];
...
-(void)drawTableView3
{
    _statisticsTableView2=[[UITableView alloc]initWithFrame:CGRectMake(0.0f, 104.0f, kScreenWidth, kScreenHeight-144) style:UITableViewStylePlain];
    ...
    _allVisitTableView=[[UITableView alloc]initWithFrame:CGRectMake(0.0f, 192.0f, kScreenWidth, kScreenHeight-232) style:UITableViewStylePlain];
